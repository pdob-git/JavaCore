...
class Company {
    public static void main(String[] args) {
        ...
        employeeWithLongestName(employees)
                .ifPresent(Company::longestExperienceEmployee);
    }
    ...
    private static Optional<String> employeeWithLongestName(List<Employee> employees) {
        return employees.stream()
                .map(Company::getKey)
                .max(Company::compareLength);
    }

    private static int compareLength(String e1, String e2){
    ...
    private static void longestExperienceEmployee(String emp) {
